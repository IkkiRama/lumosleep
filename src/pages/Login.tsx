...
const Login = () => {
  ...
  const notify = (msg: string) => {
    if (msg === "Nama pengguna atau kata sandi salah") {
      toast.error(msg, {
        position: "top-right",
        theme: "colored",
  ...
  const handleLogin = async () => {
    if (email !== "" && password !== "") {
      ...
      toast.warning("Semua formulir pendaftaran harus diisi", {
        position: "top-right",
        theme: "colored",
        className: "font-semibold",
      });
    ...
    <React.Fragment>
      ...
      <div className="flex flex-row-reverse justify-center items-center overflow-hidden">
        ...
        <div className="w-[100%] lg:w-[50%] h-screen flex justify-center items-center relative">
          {/* Decoration */}
          <div className="ball bg-mainDark rounded-full w-[150px] h-[150px] absolute -right-[20%] -top-[12%] sm:-right-[10%] sm:-top-[10%] lg:-left-[10%]"></div>

          <div className="ball hidden lg:block bg-mainDark rounded-full w-[150px] h-[150px] absolute -left-[10%] -bottom-[10%]"></div>
