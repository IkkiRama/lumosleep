...
export default function Footer() {
  return (
    <div className="w-full h-fit bg-[#0081a1d7] pt-4 pb-0 lg:py-6 flex justify-center lg:justify-normal items-center flex-col">
        ...
        <div className="content-footer flex flex-col w-full gap-2 sm:gap-3 lg:gap-4 text-white">
          <div className="top-menu border-b border-white py-2 pb-3 sm:pb-4 flex justify-between items-center mb-2">
            ...
            <div className="social-media hidden lg:flex justify-center items-center gap-4 lg:gap-5 text-lg sm:text-xl lg:text-2xl">
              ...
              <Link target="_blank" to="https://www.linkedin.com/in/rifki-romadhan">
                <FaLinkedin className="cursor-pointer" />
              </Link>
              <Link target="_blank" to="https://instagram.com/george_ikki">
                <FaInstagram className="cursor-pointer" />
              </Link>
              <Link target="_blank" to="https://github.com/IkkiRama">
                <FaGithub className="cursor-pointer" />
              </Link>
              <Link
                target="_blank"
                to="https://www.youtube.com/@ikkirama4479"
              >
          ...
          <div className="copyright-wide hidden lg:flex items-center gap-1 sm:gap-2 text-xs sm:text-base lg:text-lg">
            ...
            <div>
              2024 Dibuat oleh <span className="font-bold">Ngarah Osmo</span>
            </div>
          </div>
      ...
      <div className="copyright lg:hidden py-2 sm:py-3 bg-mainDark flex items-center gap-1 sm:gap-2 text-[0.7rem] sm:text-base lg:text-lg text-white mt-5 w-full justify-center">
        <FaRegCopyright className="font-bold" />
        <div>
          2024 Made By <span className="font-bold">Natus Vincere</span>
        </div>
      </div>
    </div>
  );
